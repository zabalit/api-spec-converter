...
function convertToSwagger(wadl) {
  ...
  var swagger = {
    ...
    info: {
      ...
      host:  baseUrl ? baseUrl.host() || undefined : undefined,
      basePath: baseUrl ? baseUrl.pathname() || undefined : undefined,
      schemes: baseUrl ? baseUrl.protocol() ? [baseUrl.protocol()] : undefined : undefined,
    paths: {}
  };
